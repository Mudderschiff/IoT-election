\doxysection{components/model/util/crypto\+\_\+utils.c File Reference}
\hypertarget{crypto__utils_8c}{}\label{crypto__utils_8c}\index{components/model/util/crypto\_utils.c@{components/model/util/crypto\_utils.c}}
{\ttfamily \#include "{}crypto\+\_\+utils.\+h"{}}\newline
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{crypto__utils_8c_aff67e835c7e405597f93aa91dca2e4b5}{print\+\_\+sp\+\_\+int}} (sp\+\_\+int \texorpdfstring{$\ast$}{*}num)
\item 
void \mbox{\hyperlink{crypto__utils_8c_a8b7b8d488cca80d6517c77555d74e5af}{int\+\_\+to\+\_\+bytes}} (int value, unsigned char \texorpdfstring{$\ast$}{*}bytes)
\item 
void \mbox{\hyperlink{crypto__utils_8c_a608e1af387f583bb689c693354314640}{print\+\_\+byte\+\_\+array}} (const byte \texorpdfstring{$\ast$}{*}array, int size)
\item 
int \mbox{\hyperlink{crypto__utils_8c_aca535cef821ca793221e687189807cbf}{kdf\+\_\+xor}} (sp\+\_\+int \texorpdfstring{$\ast$}{*}key, sp\+\_\+int \texorpdfstring{$\ast$}{*}salt, sp\+\_\+int \texorpdfstring{$\ast$}{*}message, sp\+\_\+int \texorpdfstring{$\ast$}{*}encrypted\+\_\+message)
...
int \mbox{\hyperlink{crypto__utils_8c_ae261a8d309f7d924882217bc88102df6}{rand\+\_\+q}} (sp\+\_\+int \texorpdfstring{$\ast$}{*}result)
...
int \mbox{\hyperlink{crypto__utils_8c_acbac67d33867633b72810b465351dbc1}{hash}} (sp\+\_\+int \texorpdfstring{$\ast$}{*}a, sp\+\_\+int \texorpdfstring{$\ast$}{*}b, sp\+\_\+int \texorpdfstring{$\ast$}{*}result)
...
int \mbox{\hyperlink{crypto__utils_8c_a1aaac21ca15f371368fcb20d028fc130}{compute\+\_\+polynomial\+\_\+coordinate}} (uint8\+\_\+t \texorpdfstring{$\ast$}{*}exponent\+\_\+modifier, \mbox{\hyperlink{struct_election_polynomial}{Election\+Polynomial}} \texorpdfstring{$\ast$}{*}polynomial, sp\+\_\+int \texorpdfstring{$\ast$}{*}coordinate)
...
int \mbox{\hyperlink{crypto__utils_8c_a18fa85661e1754a2b5acc63843de9c49}{verify\+\_\+polynomial\+\_\+coordinate}} (uint8\+\_\+t \texorpdfstring{$\ast$}{*}exponent\+\_\+modifier, \mbox{\hyperlink{struct_election_polynomial}{Election\+Polynomial}} \texorpdfstring{$\ast$}{*}polynomial, sp\+\_\+int \texorpdfstring{$\ast$}{*}coordinate)
\begin{DoxyCompactList}\small\item\em Computes a single coordinate value of the election polynomial used for sharing. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{crypto__utils_8c_aae3fcced9582ecec734a89d4d4bb1a4d}{get\+\_\+hmac}} (unsigned char \texorpdfstring{$\ast$}{*}key, unsigned char \texorpdfstring{$\ast$}{*}in, unsigned char \texorpdfstring{$\ast$}{*}out)
\begin{DoxyCompactList}\small\item\em Get a hash-\/based message authentication code(hmac) digest. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{crypto__utils_8c_a2ab953bf2847797172dddfc727846c91}{hashed\+\_\+elgamal\+\_\+encrypt}} (sp\+\_\+int \texorpdfstring{$\ast$}{*}message, sp\+\_\+int \texorpdfstring{$\ast$}{*}\mbox{\hyperlink{crypto__utils_8c_a3a242a0b40dede1b761d8c880a6ce387}{nonce}}, sp\+\_\+int \texorpdfstring{$\ast$}{*}public\+\_\+key, sp\+\_\+int \texorpdfstring{$\ast$}{*}encryption\+\_\+seed, \mbox{\hyperlink{struct_hashed_el_gamal_ciphertext}{Hashed\+El\+Gamal\+Ciphertext}} \texorpdfstring{$\ast$}{*}encrypted\+\_\+message)
\item 
int \mbox{\hyperlink{crypto__utils_8c_ac608c7e033a1f968996b3291145e52de}{hashed\+\_\+elgamal\+\_\+decrypt}} (\mbox{\hyperlink{struct_hashed_el_gamal_ciphertext}{Hashed\+El\+Gamal\+Ciphertext}} \texorpdfstring{$\ast$}{*}encrypted\+\_\+message, sp\+\_\+int \texorpdfstring{$\ast$}{*}secret\+\_\+key, sp\+\_\+int \texorpdfstring{$\ast$}{*}encryption\+\_\+seed, sp\+\_\+int \texorpdfstring{$\ast$}{*}message)
\item 
int \mbox{\hyperlink{crypto__utils_8c_a0ef8f5df434fea9ec8d927c3880c60fe}{generate\+\_\+polynomial}} (\mbox{\hyperlink{struct_election_polynomial}{Election\+Polynomial}} \texorpdfstring{$\ast$}{*}polynomial)
\begin{DoxyCompactList}\small\item\em Generates a polynomial for sharing election keys. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{crypto__utils_8c_aa09f7fb591e63268ec4987d2500cb561}{elgamal\+\_\+combine\+\_\+public\+\_\+keys}} (\mbox{\hyperlink{struct_election_key_pair}{Election\+Key\+Pair}} \texorpdfstring{$\ast$}{*}\mbox{\hyperlink{adapter_8c_ab8b086fa271490586e2074c2f20ebda8}{pubkey\+\_\+map}}, size\+\_\+t count, \mbox{\hyperlink{struct_election_joint_key}{Election\+Joint\+Key}} \texorpdfstring{$\ast$}{*}joint\+\_\+key)
\item 
int \mbox{\hyperlink{crypto__utils_8c_a9d5671e5caaf2f317f7cf58785de0108}{hash\+\_\+keys}} (\mbox{\hyperlink{struct_election_key_pair}{Election\+Key\+Pair}} \texorpdfstring{$\ast$}{*}\mbox{\hyperlink{adapter_8c_ab8b086fa271490586e2074c2f20ebda8}{pubkey\+\_\+map}}, size\+\_\+t count, \mbox{\hyperlink{struct_election_joint_key}{Election\+Joint\+Key}} \texorpdfstring{$\ast$}{*}joint\+\_\+key)
\item 
int \mbox{\hyperlink{crypto__utils_8c_a3a242a0b40dede1b761d8c880a6ce387}{nonce}} (sp\+\_\+int \texorpdfstring{$\ast$}{*}seed, sp\+\_\+int \texorpdfstring{$\ast$}{*}nonce)
\begin{DoxyCompactList}\small\item\em Generates a random element in \mbox{[}0,Q) from an initial element in \mbox{[}0,Q). If you start with the same seed, you\textquotesingle{}ll get exactly the same number. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{crypto__utils_8c_a8fbbd04ef6759e5f2ad5afeea05b92af}{compute\+\_\+decryption\+\_\+share\+\_\+for\+\_\+contest}} (\mbox{\hyperlink{struct_election_key_pair}{Election\+Key\+Pair}} \texorpdfstring{$\ast$}{*}\mbox{\hyperlink{adapter_8c_aae75fb47be17f4de5fa259b3d4c5d7f0}{guardian}}, \mbox{\hyperlink{struct_ciphertext_tally_contest}{Ciphertext\+Tally\+Contest}} \texorpdfstring{$\ast$}{*}contest, sp\+\_\+int \texorpdfstring{$\ast$}{*}base\+\_\+hash, \mbox{\hyperlink{struct_ciphertext_decryption_contest}{Ciphertext\+Decryption\+Contest}} \texorpdfstring{$\ast$}{*}dec\+\_\+contest)
\end{DoxyCompactItemize}


\doxysubsection{Function Documentation}
\Hypertarget{crypto__utils_8c_a8fbbd04ef6759e5f2ad5afeea05b92af}\label{crypto__utils_8c_a8fbbd04ef6759e5f2ad5afeea05b92af} 
\index{crypto\_utils.c@{crypto\_utils.c}!compute\_decryption\_share\_for\_contest@{compute\_decryption\_share\_for\_contest}}
\index{compute\_decryption\_share\_for\_contest@{compute\_decryption\_share\_for\_contest}!crypto\_utils.c@{crypto\_utils.c}}
...
\Hypertarget{crypto__utils_8c_a1aaac21ca15f371368fcb20d028fc130}\label{crypto__utils_8c_a1aaac21ca15f371368fcb20d028fc130} 
\index{crypto\_utils.c@{crypto\_utils.c}!compute\_polynomial\_coordinate@{compute\_polynomial\_coordinate}}
\index{compute\_polynomial\_coordinate@{compute\_polynomial\_coordinate}!crypto\_utils.c@{crypto\_utils.c}}
...
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_aa09f7fb591e63268ec4987d2500cb561}\label{crypto__utils_8c_aa09f7fb591e63268ec4987d2500cb561} 
\index{crypto\_utils.c@{crypto\_utils.c}!elgamal\_combine\_public\_keys@{elgamal\_combine\_public\_keys}}
\index{elgamal\_combine\_public\_keys@{elgamal\_combine\_public\_keys}!crypto\_utils.c@{crypto\_utils.c}}
...
\Hypertarget{crypto__utils_8c_a0ef8f5df434fea9ec8d927c3880c60fe}\label{crypto__utils_8c_a0ef8f5df434fea9ec8d927c3880c60fe} 
\index{crypto\_utils.c@{crypto\_utils.c}!generate\_polynomial@{generate\_polynomial}}
\index{generate\_polynomial@{generate\_polynomial}!crypto\_utils.c@{crypto\_utils.c}}
...
0 on success, -\/1 on failure 
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_aae3fcced9582ecec734a89d4d4bb1a4d}\label{crypto__utils_8c_aae3fcced9582ecec734a89d4d4bb1a4d} 
\index{crypto\_utils.c@{crypto\_utils.c}!get\_hmac@{get\_hmac}}
\index{get\_hmac@{get\_hmac}!crypto\_utils.c@{crypto\_utils.c}}
...
error\+\_\+code 
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_acbac67d33867633b72810b465351dbc1}\label{crypto__utils_8c_acbac67d33867633b72810b465351dbc1} 
\index{crypto\_utils.c@{crypto\_utils.c}!hash@{hash}}
\index{hash@{hash}!crypto\_utils.c@{crypto\_utils.c}}
...
0 on success, -\/1 on failure 
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_a9d5671e5caaf2f317f7cf58785de0108}\label{crypto__utils_8c_a9d5671e5caaf2f317f7cf58785de0108} 
\index{crypto\_utils.c@{crypto\_utils.c}!hash\_keys@{hash\_keys}}
\index{hash\_keys@{hash\_keys}!crypto\_utils.c@{crypto\_utils.c}}
...
\Hypertarget{crypto__utils_8c_ac608c7e033a1f968996b3291145e52de}\label{crypto__utils_8c_ac608c7e033a1f968996b3291145e52de} 
\index{crypto\_utils.c@{crypto\_utils.c}!hashed\_elgamal\_decrypt@{hashed\_elgamal\_decrypt}}
\index{hashed\_elgamal\_decrypt@{hashed\_elgamal\_decrypt}!crypto\_utils.c@{crypto\_utils.c}}
...
\hline
\end{DoxyParams}
\Hypertarget{crypto__utils_8c_a2ab953bf2847797172dddfc727846c91}\label{crypto__utils_8c_a2ab953bf2847797172dddfc727846c91} 
\index{crypto\_utils.c@{crypto\_utils.c}!hashed\_elgamal\_encrypt@{hashed\_elgamal\_encrypt}}
\index{hashed\_elgamal\_encrypt@{hashed\_elgamal\_encrypt}!crypto\_utils.c@{crypto\_utils.c}}
...
\hline
\end{DoxyParams}
\Hypertarget{crypto__utils_8c_a8b7b8d488cca80d6517c77555d74e5af}\label{crypto__utils_8c_a8b7b8d488cca80d6517c77555d74e5af} 
\index{crypto\_utils.c@{crypto\_utils.c}!int\_to\_bytes@{int\_to\_bytes}}
\index{int\_to\_bytes@{int\_to\_bytes}!crypto\_utils.c@{crypto\_utils.c}}
...
\Hypertarget{crypto__utils_8c_aca535cef821ca793221e687189807cbf}\label{crypto__utils_8c_aca535cef821ca793221e687189807cbf} 
\index{crypto\_utils.c@{crypto\_utils.c}!kdf\_xor@{kdf\_xor}}
\index{kdf\_xor@{kdf\_xor}!crypto\_utils.c@{crypto\_utils.c}}
...
0 on success, 1 on failure 
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_a3a242a0b40dede1b761d8c880a6ce387}\label{crypto__utils_8c_a3a242a0b40dede1b761d8c880a6ce387} 
\index{crypto\_utils.c@{crypto\_utils.c}!nonce@{nonce}}
\index{nonce@{nonce}!crypto\_utils.c@{crypto\_utils.c}}
\doxysubsubsection{\texorpdfstring{nonce()}{nonce()}}
{\footnotesize\ttfamily int nonce (\begin{DoxyParamCaption}\item[{sp\+\_\+int \texorpdfstring{$\ast$}{*}}]{seed,  }\item[{sp\+\_\+int \texorpdfstring{$\ast$}{*}}]{nonce }\end{DoxyParamCaption})}



Generates a random element in \mbox{[}0,Q) from an initial element in \mbox{[}0,Q). If you start with the same seed, you\textquotesingle{}ll get exactly the same number. 


\begin{DoxyParams}{Parameters}
{\em seed} & The seed for the random number \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 on success, -\/1 on failure 
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_a608e1af387f583bb689c693354314640}\label{crypto__utils_8c_a608e1af387f583bb689c693354314640} 
\index{crypto\_utils.c@{crypto\_utils.c}!print\_byte\_array@{print\_byte\_array}}
\index{print\_byte\_array@{print\_byte\_array}!crypto\_utils.c@{crypto\_utils.c}}
...
\Hypertarget{crypto__utils_8c_aff67e835c7e405597f93aa91dca2e4b5}\label{crypto__utils_8c_aff67e835c7e405597f93aa91dca2e4b5} 
\index{crypto\_utils.c@{crypto\_utils.c}!print\_sp\_int@{print\_sp\_int}}
\index{print\_sp\_int@{print\_sp\_int}!crypto\_utils.c@{crypto\_utils.c}}
...
\Hypertarget{crypto__utils_8c_ae261a8d309f7d924882217bc88102df6}\label{crypto__utils_8c_ae261a8d309f7d924882217bc88102df6} 
\index{crypto\_utils.c@{crypto\_utils.c}!rand\_q@{rand\_q}}
\index{rand\_q@{rand\_q}!crypto\_utils.c@{crypto\_utils.c}}
...
0 on success, -\/1 on failure 
\end{DoxyReturn}
\Hypertarget{crypto__utils_8c_a18fa85661e1754a2b5acc63843de9c49}\label{crypto__utils_8c_a18fa85661e1754a2b5acc63843de9c49} 
\index{crypto\_utils.c@{crypto\_utils.c}!verify\_polynomial\_coordinate@{verify\_polynomial\_coordinate}}
\index{verify\_polynomial\_coordinate@{verify\_polynomial\_coordinate}!crypto\_utils.c@{crypto\_utils.c}}
